...
<body>
	...
	<div class="wrappe wrappe-upload">
		...
		<div class="content content-upload">
			...
			<form action="${pageContext.request.contextPath }/my/soft/editExecution" method="post" enctype="multipart/form-data" name="con-upload" id="ocheck" onsubmit="return fs()">
			<ul>
			<li>
				<div class="name">
				...
				<div class="size_ts">
					...
					<div class="baidu_upload">
						<input type="text" class="baidu_link" id="baidu_link" name="baiduLink" value="${baiduLink.bdLink }" placeholder="请输入百度网盘地址" disabled="disabled">
					</div>
				...
				<div class="rar">
	        		...
	        		<div class="edit_ts"><p>默认不修改软件和图标，您也可以<a href="javascript:void(0);" onclick="switchEdit();" id="switchEdit">启用修改</a></p></div>
		        </div> 
