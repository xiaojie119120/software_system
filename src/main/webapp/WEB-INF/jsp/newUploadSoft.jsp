...
<body>
	...
	<div class="wrappe wrappe-upload">
		...
		<div class="content content-upload">
			...
			<li>
				...
				<div class="rar">
					<input type="file" name="file" id="fileInput1" value=""/>
					<p class="ti">选择上传的软件</p>
					<div class='lx'>
	            ...
	            <div id="icon" style="font-size:12px;color:#0e97e6;margin-left:150px">
	            	<input type="file" name="icon" style="outline:none;border:none" onchange="PreviewImage(this)" id="fileInput2"/>
					<p>图标</p>
	        	</div> 
	        </div> 
	...
	function PreviewImage(imgFile){
		...
		if(Imgk!=null&&!pattern.test(Imgk)){
